...
var TermLabel = function (_Component) {
    ...
    function TermLabel() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TermLabel.__proto__ || Object.getPrototypeOf(TermLabel)).call.apply(_ref, [this].concat(args))), _this), _this.render = function () {
            var cssClass = _this.props.isSelected ? 'tag-label selected-element' : 'tag-label';
            return _react2.default.createElement(
                'p',
                { style: _this.props.style, className: cssClass, onClick: _this.onClick },
                _this.props.value
            );
        }, _this.onClick = function () {
            _this.props.onLabelClick(_this.props.value);
