...
var _ActiveTermsList = require('../components_DEPRECATED/ActiveTermsList');

var _ActiveTermsList2 = _interopRequireDefault(_ActiveTermsList);

var _TermSettings = require('../components_DEPRECATED/TermSettings');
	...
	_createClass(OutputArea, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: 'output-area col-sm-5 col-xs-12 col-md-4' },
